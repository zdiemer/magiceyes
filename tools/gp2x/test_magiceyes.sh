...
set -eu
export MAGICEYES_SDK=/mnt/e/Code/magiceyes/assets/sdk/GPH_SDK
export MAGICEYES_ROOTFS=/mnt/e/Code/magiceyes/assets/rootfs/0/rootfs
...
GDIR=/mnt/e/Code/magiceyes/assets/games/doukutsu/doukutsu
cd "$GDIR"
...
sleep 7
python3 /mnt/e/Code/magiceyes/assets/shim/snap.py \
  /mnt/e/Code/magiceyes/assets/shots/magiceyes_test.png
